              ...
              <span className="featuredSpan" style={{ display: 'flex', flexDirection: 'row' }}>
                ...
                <span style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>          
                  ...
                  <div className="featured-summary" >
                    <p> This is my unofficial love letter to Los Angeles. I've been in this city for over seven years, but I didn't start venturing out restaurant-wise until I graduated from college.</p>
